...
(ert-deftest test-grc-sort-by ()
  (let ((lst '(((str . "a") (num . 10))
               ...
               ((str . "c") (num . 16))
               ((str . "c") (num . 2)))))
    (should (string= "a" (aget (first (grc-sort-by 'str lst)) 'str)))
    (should (string= "c" (aget (car (last (grc-sort-by 'str lst))) 'str)))
    (should (string= "c" (aget (first (grc-sort-by 'str lst t)) 'str)))
    (should (= 2 (aget (car (last (grc-sort-by 'str lst))) 'num)))
    (should (= 16 (aget (car (last (grc-sort-by 'str lst nil 'num))) 'num)))
    (should (= 16 (aget (first (grc-sort-by 'str lst t 'num)) 'num)))))
