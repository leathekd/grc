...
(setq grc-test-parse-json-entry
      '((origin (htmlUrl . "url") (title . "title") (streamId . "id"))
        (annotations ((profileCardParams . "params") (profileId . "profile-id")
                      ...
                      (content . "content")))
        (comments ((isSpam . :json-false) (modifiedTime . 1313874340)
                   (createdTime . 1313874340) (venueStreamId . "v-id")
                   (profileCardParams . "params")
                   (profileId . "profile-id") (userId . "user-id")
                   (author . "author") (htmlContent . "comment1")
                   (plainContent . "comment1")
                   (id . "comment-id")))
...
(setq grc-test-parse-json-entry-parsed
      '((id . "id") (date . 1313949960) (crawl-date . 1313949974)
        ...
        (comments ((isSpam . :json-false)
                   (modifiedTime . 1313874340)
                   (createdTime . 1313874340)
                   (venueStreamId . "v-id")
                   (profileCardParams . "params")
                   (profileId . "profile-id")
                   (userId . "user-id")
                   (author . "author")
                   (htmlContent . "comment1")
                   (plainContent . "comment1")
                   (id . "comment-id")))))
